...
function Education() {
  return (
    <section id="formacion" className="mx-auto max-w-7xl px-6 py-16 sm:py-24">
      <SectionHeading
        align="center"
        eyebrow="Formación"
      ...
      <div className="mt-10 grid gap-5 sm:mt-12 sm:gap-6 md:grid-cols-2">
        {education.map((item) => (
          <article key={item.title} className="glass glass-hover flex flex-col p-5 sm:p-7">
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="badge badge-brand shrink-0">{item.role}</span>
            </div>
